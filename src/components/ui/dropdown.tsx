    ...
    >
      <HeadlessMenuItems
        ...
        className={cn(
          ...
          // Popover background
          'bg-default/80 backdrop-blur-xl ',
  ...
  return (
    <HeadlessMenuItem
      ...
      className={cn(
        ...
        // Base styles
        'group cursor-default rounded-sm px-3.5 py-2.5 focus:outline-none sm:px-3 sm:py-1.5',

        // Text styles
        'text-left text-base/6 text-default  sm:text-sm/6 forced-colors:text-[CanvasText]',

        // Focus
        'data-[focus]:bg-secondary/50 data-[focus]:text-white',
